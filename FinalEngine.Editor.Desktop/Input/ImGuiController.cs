...
using MouseButton = FinalEngine.Input.Mouses.MouseButton;
using Vector2 = System.Numerics.Vector2;

public class ImGuiController : IGizmoController, IDisposable
{
    ...
    public ImGuiController(IKeyboard keyboard, IMouse mouse)
    {
        this.keyboard = keyboard ?? throw new ArgumentNullException(nameof(keyboard));
        this.mouse = mouse ?? throw new ArgumentNullException(nameof(mouse));
        this._windowWidth = 1280;
...
void main()
{
    ...
    {
        this.WindowResized(width, height);
    }
    ...
    public void Update()
    {
        ...
        this.SetPerFrameImGuiData(GameTime.Delta);
        this.UpdateImGuiInput(this.keyboard, this.mouse);
